CREATE TABLE conta_credito (
	...
	CONSTRAINT `fk_conta_credito_conta_debito`
  	...
  	REFERENCES `conta_debito` (`cd_banco`, `cd_agencia`, `cd_conta`, `cd_digito`, `cd_tipo_conta`)
  	ON DELETE NO ACTION
  	ON UPDATE NO ACTION,
...
INSERT INTO conta_credito (cd_banco, cd_agencia, cd_conta, cd_digito, cd_tipo_conta, cd_cnpj_cpf, nome_favorecido, cd_tipo_pessoa, cd_tipo_conta_pagamento, cd_banco_de, cd_agencia_de, cd_conta_de, cd_digito_de, cd_tipo_conta_de) VALUES (347, 2516, 5420, 8, 2, 22783088827, 'Andre Lemos', 2, 1, 341, 3718, 2516, 8, 2);
