...
INSERT INTO `basefavorecido`.`conta_debito` (`cd_cnpj_cpf`, `cd_banco`, `cd_agencia`, `cd_conta`, `cd_digito`, `cd_tipo_conta`, `nome_cliente`, `cd_tipo_pessoa`) VALUES (44918885071, 341, 3718, 2516, 8, 2, 'Andre Lemos', 2);
